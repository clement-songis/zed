...
messages!(
    ...
    (GitSequencerAbort, Background),
    (GitSequencerAdvance, Background),
    (GitMerge, Background),
    (GitRebase, Background),
    (GitCherryPick, Background),
    (GitCherryPickResponse, Background),
    (GitRevert, Background),
    (GitRevertResponse, Background),
    (GitRebaseResponse, Background),
...
request_messages!(
    ...
    (GitDeleteTag, Ack),
    (GitCheckoutTag, Ack),
    (GitSequencerAbort, Ack),
    (GitSequencerAdvance, Ack),
    (GitMerge, GitMergeResponse),
    (GitRebase, GitRebaseResponse),
    (GitCherryPick, GitCherryPickResponse),
    (GitRevert, GitRevertResponse),
    (GitApplyPatch, Ack),
    (GitChangeBranch, Ack),
    (GitRenameBranch, Ack),
